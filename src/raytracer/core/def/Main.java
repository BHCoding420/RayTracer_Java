...
public class Main {
	...
	public static void main(final String[] args) {
		...
		final boolean implementedPlane = true; // implement Plane
		final boolean implementedCheckerBoard = true; // implement CheckerBoard
		final boolean implementedSphere = true; // implement Sphere
		final boolean implementedPhong = true; // implement Phong
		final boolean implementedOBJReader = true; // implement OBJReader
		final boolean implementedBVH = false; // implement BVH
